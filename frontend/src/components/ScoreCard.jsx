      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
        ...
        <div className="flex-1 text-center md:text-left flex flex-col items-center md:items-start">
          ...
          >
            ...
            <span className="text-sm font-medium uppercase tracking-widest mt-1 opacity-80">{getScoreLabel(score)}</span>
          </motion.div>
        </div>
              ...
              {Object.entries(details).map(([key, value], i) => (
                ...
                >
                  <div className="flex items-center gap-3 text-slate-400 capitalize">
                    ...
                    <span className="font-medium text-sm">{key.replace(/([A-Z])/g, ' $1').trim()}</span>
                  </div>
